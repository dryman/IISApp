...
=head1 Notes on Mojolicous

Just a reading note for Perl Mojolicous framework

=head1 Foundamentals of Modern Web Framework concerns
...
=item query parameters C</?user=sir&passwd=secr3t>

=item POST parameters  

=item route placeholders C</:name>
...
=head2 Placeholders and stash value
